...
@section('title') Add Sub Admin @stop

@section('pagetitle') Add Sub Admin @stop
  ...
  <form action="" method="post" id="userdata">
    ...
    <div class="row">
          <div class='form-group'>
              ...
              <div class="col-lg-5">
                  {{ Form::text('first_name', null, ['placeholder' => 'First Name', 'class' => 'form-control']) }}<br />
              </div>
              <div class="col-lg-5">
      ...
      <div class="row">
          <div class='form-group'>
              ...
              <div class="col-lg-5">
                  {{ Form::text('last_name', null, ['placeholder' => 'Last Name', 'class' => 'form-control']) }}<br />
              </div>
              <div class="col-lg-5">
      ...
      <div class="row">
          <div class='form-group'>
              ...
              <div class="col-lg-5">
                  {{ Form::text('phone', null, ['placeholder' => 'Phone', 'class' => 'form-control']) }}<br />
              </div>
              <div class="col-lg-5">
      ...
      <div class="row">
          <div class='form-group'>
              ...
              <div class="col-lg-5">
                  {{ Form::text('mobile', null, ['placeholder' => 'Mobile', 'class' => 'form-control']) }}<br />
              </div>
              <div class="col-lg-5">
          ...
          <div class='form-group'>
              ...
              <div class="col-lg-5">
                  <select name="country" class="form-control">
                    ...
                    <option value="<?php echo $country;?>" <?php if(Input::old('country')==$country){?> selected="selected" <?php }?>><?php echo $country;?></option>
                    <?php } } ?>
                  </select>
                  <br />
              </div>
          ...
          <div class='form-group'>
              ...
              <div class="col-lg-5">
                  <select name="state" class="form-control">
                    ...
                    <option value="<?php echo $state;?>" <?php if(Input::old('state')==$state){?> selected="selected" <?php }?>><?php echo $state;?></option>
                    <?php } } ?>
                  </select>
                  <br />
              </div>
          ...
          <div class='form-group'>
              ...
              <div class="col-lg-5">
                  <select name="city" class="form-control">
                    ...
                    <option value="<?php echo $city;?>" <?php if(Input::old('city')==$city){?> selected="selected" <?php }?>><?php echo $city;?></option>
                            <?php } } ?>
                  </select>
                  <br />
              </div>
              ...
              <div class="col-lg-10">
                  <?php if($rolls){foreach ($rolls as $roll):  ?>
                      <div style="width:25%; float:left;">
                        <input type="checkbox" name="rolls[]" value="<?php echo $roll->id;?>" <?php if(is_array(Input::old('rolls'))){ 
                        if(in_array($roll->id,Input::old('rolls'))){?> checked="checked" <?php }}?>/>
                        &nbsp;<?php echo $roll->title; ?></div>
                    <?php endforeach; } ?>
              </div>
          </div>
      </div>
